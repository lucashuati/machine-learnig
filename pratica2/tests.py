...
class TestDecisionTree(unittest.TestCase):
        ...
        def test_divide_treino_teste(self):
            ...
            self.assertEqual(list(df_treino["C"]),[123, 22, 44, 12, 23, 55, 3, 21],"O treino não está com os valores previstos")
            self.assertEqual(list(df_teste["C"]), [33,55],"O teste não está com os valores previstos")
